...
public:
    ...
    Color get_shooter_color()                                                                                                           // Modification (Added)
    {
        // return the color of the shooter
        return color;
    }

    void set_shooter_color(Color colour)                                                                                                // Modification (Added)
    {
        // Set/change the colour of the shooter to the colour passed in as argument
